package net.jaedong.library.selectabletextview;
...
import net.jaedong.library.selectabletextview.util.CommonUtil;
import net.jaedong.library.selectabletextview.view.CustomInfo;
import net.jaedong.library.selectabletextview.view.CustomTextView;
import net.jaedong.library.selectabletextview.view.ObservableScrollView;
import net.jaedong.library.selectabletextview.view.SelectableListener;
